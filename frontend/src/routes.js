...
const CustomerTable = React.lazy(() => import('./views/dashboard/CustomerDash'))
const CustomerAdd = React.lazy(() => import('./views/add/CustomerAdd'))
const CustomerEdit = React.lazy(() => import('./views/edit/CustomerEdit'))

const UserTable = React.lazy(() => import('./views/dashboard/UserDash'))
const UserAdd = React.lazy(() => import('./views/add/UserAdd'))
const UserEdit = React.lazy(() => import('./views/edit/UserEdit'))

const Category = React.lazy(() => import('./views/dashboard/Category'))
const CategoryAdd = React.lazy(() => import('./views/add/CategoryAdd'))
const CategoryEdit = React.lazy(() => import('./views/edit/CategoryEdit'))
